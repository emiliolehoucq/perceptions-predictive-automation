...
cred_score_ridge_cv$lambda.min # 0.4247572
cred_score_lasso_cv$lambda.min # 0.01543331
...
risk_score_ridge_cv$lambda.min # 0.3696913
risk_score_lasso_cv$lambda.min # 0.01573379
...
vid_hiring_ridge_cv$lambda.min # 0.3217642
vid_hiring_lasso_cv$lambda.min # 0.01493088
...
cv_hiring_ridge_cv$lambda.min # 0.560717
cv_hiring_lasso_cv$lambda.min # 0.01900601
